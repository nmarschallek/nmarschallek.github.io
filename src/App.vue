<template>
  <div class="bg-gray-100 min-h-screen">
      ...
      <div class="container mx-auto flex flex-col space-y-3 py-12 max-w-2xl px-5">
        <div class="flex sm:flex-row flex-col">
          ...
          <div class="my-auto flex flex-col space-y-1">
            <h1 class="text-5xl text-gray-800">Nikolaus Marschallek</h1>
            <span class="text-xl text-indigo-800 font-semibold tracking-wide">Accounting & Finance Student</span>
            <div class="flex flex-row space-x-5 pt-3">
              <a
                v-for="link in links"
                :href="decode(link.url)"
                target="_blank"
                class="bg-indigo-800 text-white py-1 px-5 rounded-md flex flex-row space-x-2 hover:shadow-xl"
              >
                <svg class="my-auto" width="16" height="16" :viewBox="link.svgViewBox" v-html="link.svg"></svg>
                <span>{{ link.text }}</span>
              </a>
            </div>
          </div>
        ...
        <div class="text-gray-500">
          <p>
            Hi, I'm Nik and I'm a final year student at the Queensland University of Technology, studying a Bachelor of Business (Accounting and Finance). Here are some of the side projects that I've worked on recently.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container mx-auto pb-10 max-w-2xl px-5">
      ...
      <span v-else class="text-gray-500 italic">There are currently no projects listed.</span>
    </div>
  </div>
</template>
...
let links = reactive([
  {
    text: 'Email',
    url: 'bWFpbHRvOm5pa29sYXVzQG1hcnNjaGFsbGVrLm1l',
    svg: `
        <g fill="#fff">
  ...
  {
    text: 'LinkedIn',
    url: 'aHR0cHM6Ly9saW5rZWRpbi5jb20vaW4vbm1hcnNjaGFsbGVr',
    svg: `
        <g fill="none">
            ...
            <path d="M77.796 214.238V98.986H39.488v115.252H77.8zM58.65 83.253c13.356 0 21.671-8.85 21.671-19.91-.25-11.312-8.315-19.915-21.417-19.915-13.111 0-21.674 8.603-21.674 19.914 0 11.06 8.312 19.91 21.169 19.91h.248zM99 214.238h38.305v-64.355c0-3.44.25-6.889 1.262-9.346 2.768-6.885 9.071-14.012 19.656-14.012 13.858 0 19.405 10.568 19.405 26.063v61.65h38.304v-66.082c0-35.399-18.896-51.872-44.099-51.872-20.663 0-29.738 11.549-34.78 19.415h.255V98.99H99.002c.5 10.812-.003 115.252-.003 115.252z" fill="rgba(55, 48, 163, var(--tw-bg-opacity))"/>
        </g>
    `,
    svgViewBox: '0 0 256 249',
  },
  {
    text: 'Github',
    url: 'aHR0cHM6Ly9naXRodWIuY29tL25tYXJzY2hhbGxlaw==',
    svg: `
        <g fill="#fff">
